...
public class Solution implements Serializable {
    ...
    protected double diversity_;

    protected double associateDist_;
    ...
    public void setVariable_(Variable[] variable_) {
        this.variable_ = variable_;
    }

    public int getNumberOfObjectives_() {
        return numberOfObjectives_;
    }
    ...
    public double getFitness_() {
        return fitness_;
    }

    public void setFitness_(double fitness_) {
    ...
    public void setMarked_(boolean marked_) {
    ...
    public double getOverallConstraintViolation_() {
        return overallConstraintViolation_;
    }

    public void setOverallConstraintViolation_(double overallConstraintViolation_) {
        this.overallConstraintViolation_ = overallConstraintViolation_;
    }

    public int getNumberOfViolatedConstraints_() {
        return numberOfViolatedConstraints_;
    }

    public void setNumberOfViolatedConstraints_(int numberOfViolatedConstraints_) {
        this.numberOfViolatedConstraints_ = numberOfViolatedConstraints_;
    }
    ...
    public void setLocation_(int location_) {
        this.location_ = location_;
    }

    public double getkDistance_() {
        return kDistance_;
    }

    public void setkDistance_(double kDistance_) {
        this.kDistance_ = kDistance_;
    }
    ...
    public double getDistanceToSolutionSet_() {
        return distanceToSolutionSet_;
    }

    public void setDistanceToSolutionSet_(double distanceToSolutionSet_) {
        this.distanceToSolutionSet_ = distanceToSolutionSet_;
    }

    public double[] getCompleteObjective() {
        return objective_;
    }

    public double getDiversity_() {
        return diversity_;
    }

    public void setDiversity_(double diversity_) {
        this.diversity_ = diversity_;
    }

    public double getAssociateDist_() {
        return associateDist_;
    }

    public void setAssociateDist_(double associateDist_) {
